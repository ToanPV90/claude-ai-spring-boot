...
metadata:
  ...
  related-skills: spring-boot-master, java-code-review, clean-code, jooq-master, blaze-persistence, postgres-master
---
...
## When Not to Use
- The work is SQL-first, reporting-heavy, CTE-heavy, or database-first — use `jooq-master`
- The task is generic Spring layering or controller/service structure — use `spring-boot-master`
...
5. **Need large reporting or SQL-native features?** Move to `jooq-master`.

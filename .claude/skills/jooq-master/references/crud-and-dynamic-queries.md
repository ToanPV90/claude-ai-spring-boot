...
- If the caller really needs aggregate behavior, lifecycle callbacks, or entity graphs, go back to `jpa-master`.
- If the bigger question is where repositories belong in the service architecture, use `spring-boot-master`.

...
metadata:
  ...
  version: "1.0.0"
  domain: backend
  triggers: audit, review, codex, code review, independent review, diff review
  role: workflow
  scope: review
  output-format: analysis
  related-skills: java-code-review, clean-code
...
1. Inform the user: "Codex CLI not found. Install with `npm install -g @openai/codex`"
2. Offer alternative: "I can perform the review directly using my own analysis capabilities instead."
3. If user agrees, perform the review yourself using the same criteria (bugs, security, performance, logic errors, style).
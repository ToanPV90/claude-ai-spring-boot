...
metadata:
  ...
  related-skills: spring-boot-engineer, tdd-guide, spring-boot-master, java-code-review
---
...
- The main task is controller/service/repository ownership or application layering — use `spring-boot-master`

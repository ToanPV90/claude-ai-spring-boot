...
class UserRepositoryTest {
    ...
    void shouldFindUserByEmail() {
        // Given
        User user = new User(null, "test@example.com", "testuser", true, null, null);
    ...
    void shouldCountActiveUsers() {
        // Given
        User activeUser = new User(null, "active@example.com", "active", true, null, null);
        User inactiveUser = new User(null, "inactive@example.com", "inactive", false, null, null);
...
public class UserTestBuilder {
    ...
    public User build() {
        return new User(id, email, username, active, null, null);
    }
}
...
| `@MockitoBean` | Mock Spring bean (Spring Boot 3.4+) |

...
- If JSONB or array handling becomes part of aggregate mapping semantics, reassess whether the feature should stay in `jooq-master` or move back toward `jpa-master` / `blaze-persistence`.

...
- For Kafka header propagation and consumer restoration, load `kafka-master`.
- For Micrometer tracing, spans, and observation design, load the framework-specific implementation skill; in this repo that means `spring-boot-engineer` when Spring Boot is explicit.
